                ...
                <?php
                   ...
                   else if(isset($_SESSION['patient']))
                   {
                     ...
                     echo '
                            ...
                            <li class="nav-item"><a href="doctorlogin.php" class="nav-link text-white">Donar</a></li>
                            <li class="nav-item"><a href="patientlogin.php" class="nav-link text-white">Seeker</a></li>
                     ';
                   }
